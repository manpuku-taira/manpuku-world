/* =========================================================
  Manpuku World - v50000 (iPhone First Layout Rebuild)
  - fixed廃止 / sticky採用 / クリック吸い込み対策
  - C/E スロットは常にDOM上で見える＆押せる
========================================================= */
...
async function init(){
  ...
  log("v50000：iPhone向けレイアウト全面組み直し（fixed廃止・タップ安定）");
}
